        ...
        <form action="<?= BASEURL ?>/customer/submitReview" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    ...
                    <select name="rating" required class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-cyan-700 transition font-bold text-gray-700 text-lg">
            ...
            <div>
                ...
                <textarea name="message" rows="4" placeholder="Beri tahu kami apa yang Anda sukai, atau apa yang bisa kami tingkatkan..." class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-cyan-700 transition"><?= htmlspecialchars($existing_review['message'] ?? '') ?></textarea>
            </div>
            
            <button type="submit" class="w-full <?= isset($existing_review) ? 'bg-orange-500 hover:bg-orange-600 shadow-orange-500/30' : 'bg-primary hover:bg-cyan-800 shadow-cyan-600/30' ?> text-white font-bold py-3 px-4 rounded-xl shadow-lg transition transform hover:-translate-y-0.5 active:translate-y-0">
