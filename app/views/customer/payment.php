    ...
    <div class="bg-gradient-to-r from-cyan-50 to-white border-b border-gray-100 px-8 py-6 flex flex-col sm:flex-row justify-between sm:items-center gap-6">
        ...
        <div>
            <div class="text-right">
                ...
                <span class="text-2xl font-extrabold text-primary">Rp <?= number_format($order['total'] ?? 0, 0, ',', '.') ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="p-8">
        ...
        <form id="payment-form" action="<?= BASEURL ?>/customer/processPayment" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="rekening_name" name="rekening_name" required placeholder="Contoh: Budi Santoso" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition">
                ...
                <div class="mt-1 flex justify-center px-6 pt-8 pb-8 border-2 border-gray-300 border-dashed rounded-xl hover:bg-gray-50 transition relative group" id="upload-container">
                    <div class="space-y-2 text-center" id="upload-content">
                        ...
                        <div class="flex text-sm text-gray-600 justify-center">
                            <label for="payment_proof" class="relative cursor-pointer bg-white rounded-md font-bold text-primary hover:text-cyan-700 px-3 py-1 shadow-sm border border-cyan-100 focus-within:outline-none">
            ...
            <button type="submit" class="w-full flex justify-center items-center py-4 bg-primary text-white rounded-xl font-bold text-lg hover:bg-cyan-700 transition shadow-lg gap-2 shadow-cyan-500/30">
